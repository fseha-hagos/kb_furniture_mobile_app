    ...
    <View style={[styles.container, {  }]}>
      ...
      {isSignedIn ? (
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={[styles.profileCard, { backgroundColor: cardColor }]}>
            ...
            <View style={styles.socialRow}>
              ...
              <TouchableOpacity style={[styles.socialIcon, { backgroundColor: backgroundColor }]} onPress={telegram}>
                <Image source={require('@/assets/logo/telegram.png')} style={styles.iconImg} />
              </TouchableOpacity>
              <TouchableOpacity style={[styles.socialIcon, { backgroundColor: backgroundColor }]} onPress={insta}>
                <Image source={require('@/assets/logo/insta.png')} style={styles.iconImg} />
              </TouchableOpacity>
              <TouchableOpacity style={[styles.socialIcon, { backgroundColor: backgroundColor }]} onPress={tiktok}>
          ...
          {/* Dashboard Toggle */}
          <View style={[styles.dashboardToggle, { backgroundColor: cardColor }]}>
            <TouchableOpacity 
        ...
        <View style={styles.guestContainer}>
          ...
          />
          <Text style={[styles.guestTitle, { color: textColor }]}>Welcome, Guest!</Text>
          <Text style={[styles.guestSubtitle, { color: subtextColor }]}>Sign in to view your profile and manage your account</Text>
          <View style={styles.authButtonRow}>
            ...
            <TouchableOpacity
              style={[styles.authButton, { borderColor: accentColor, borderWidth: 1, backgroundColor: cardColor }]}
              onPress={() => router.push('/register')}
              activeOpacity={0.85}
            >
              <Ionicons name="person-add-outline" size={20} color={accentColor} style={styles.authButtonIcon} />
              <Text style={[styles.authButtonText, { color: accentColor }]}>Sign Up</Text>
            </TouchableOpacity>
          </View>
        </View>
      )}
